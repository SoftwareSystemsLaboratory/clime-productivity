...
def get_graph_args() -> Namespace:
    ...
    parser: ArgumentParser = ArgumentParser(
        prog="ssl-metrics-git-productivity Graph Utility",
        usage="Graphing utility to visualize statistics from the SSL Metrics Git Productivity Extraction Utility",
        description="This prgram takes in a JSON file of values extracted from a git repository with ssl-metrics-git-productivity",
